...
void PickPlaceTask::addCurrentStateStageToTask(const std::string &object, Task &t){
	/****************************************************
	 *                                                  *
	 *               Current State                      *
	 *                                                  *
...
void PickPlaceTask::addOpenHandStageToTask(std::shared_ptr<solvers::PipelinePlanner> &sampling_planner, Stage *&initial_state_ptr, Task &t){
	/****************************************************
	 *                                                  *
	 *               Open Hand                          *
	 *                                                  *
...
void PickPlaceTask::addMoveToPickStageToTask(std::shared_ptr<solvers::PipelinePlanner> &sampling_planner, Task &t){
	/****************************************************
	 *                                                  *
	 *               Move to Pick                       *
	 *                                                  *
...
void PickPlaceTask::addPickObjectStageToTask(const std::string &object, std::shared_ptr<solvers::PipelinePlanner> &sampling_planner, std::shared_ptr<solvers::CartesianPath> &cartesian_planner, Stage* initial_state_ptr, Stage*& pick_stage_ptr, Task &t){
	/****************************************************
	 *                                                  *
	 *               Pick Object                        *
	 *                                                  *
	...
	// Define the grasp serial stage container
	auto grasp = std::make_unique<SerialContainer>("pick object");
	t.properties().exposeTo(grasp->properties(), { "eef", "hand","group", "ik_frame" });
	grasp->properties().configureInitFrom(Stage::PARENT, { "eef", "hand","group", "ik_frame" });

	// Initialize a sequence of stages to put into the grasp container
	...
	// remember for monitoring place pose generator
...
void PickPlaceTask::addApproachObjectStageToContainer(std::shared_ptr<solvers::CartesianPath> &cartesian_planner, std::unique_ptr<SerialContainer> &container){
	/***************************************************
	---- *               Approach Object               *
	***************************************************/
...
void PickPlaceTask::addGenerateGraspPoseStageToContainer(const std::string &object, Stage* initial_state_ptr, std::unique_ptr<SerialContainer> &container){
...
void PickPlaceTask::addAllowHandObjectCollisionStageToContainer(Task &t, const std::string &object, std::unique_ptr<SerialContainer> &container){
...
void PickPlaceTask::addCloseHandStageToContainer(std::shared_ptr<solvers::PipelinePlanner> &sampling_planner, std::unique_ptr<SerialContainer> &container){
...
void PickPlaceTask::addAttachObjectStageToContainer(const std::string &object, std::unique_ptr<SerialContainer> &container){
...
void PickPlaceTask::addAllowObjectSupportCollisionStageToContainer(const std::string &object, std::unique_ptr<SerialContainer> &container){
...
void PickPlaceTask::addLiftObjectStageToContainer(std::shared_ptr<solvers::CartesianPath> &cartesian_planner, std::unique_ptr<SerialContainer> &container){
/****************************************************
 *               Lift object                        *
 ***************************************************/
...
void PickPlaceTask::addForbidObjectSupportCollisionStageToContainer(const std::string &object, std::unique_ptr<SerialContainer> &container){
...
void PickPlaceTask::addMoveToPlaceStageToTask(std::shared_ptr<solvers::PipelinePlanner> &sampling_planner, Task &t){
	/******************************************************
	 *                                                    *
	 *          Move to Place                             *
	 *                                                    *
...
void PickPlaceTask::addPlaceObjectStageToTask(const std::string &object, std::shared_ptr<solvers::PipelinePlanner> &sampling_planner, std::shared_ptr<solvers::CartesianPath> &cartesian_planner, Stage* pick_stage_ptr, Task &t){
...
void PickPlaceTask::addLowerObjectStageToContainer(std::shared_ptr<solvers::CartesianPath> &cartesian_planner, std::unique_ptr<SerialContainer> &container){
...
void PickPlaceTask::addGeneratePlacePoseStageToContainer(const std::string &object, Stage* pick_stage_ptr, std::unique_ptr<SerialContainer> &container){
...
void PickPlaceTask::addOpenHandStageToContainer(std::shared_ptr<solvers::PipelinePlanner> &sampling_planner, std::unique_ptr<SerialContainer> &container){
...
void PickPlaceTask::addForbidArmObjectCollisionStageToContainer(Task &t, std::unique_ptr<SerialContainer> &container){

/*****************************************************
 *          Forbid collision (arm, object)        	 *
*****************************************************/

// TODO: Why not use object, but object_name member variable here? Ideally consistent in all functions
	auto stage = std::make_unique<stages::ModifyPlanningScene>("forbid collision (hand,object)");
	stage->allowCollisions(object_name_, *t.getRobotModel()->getJointModelGroup(hand_group_name_), false);
	container->insert(std::move(stage));
}

void PickPlaceTask::addDetachObjectStageToContainer(std::unique_ptr<SerialContainer> &container){
...
void PickPlaceTask::addRetreatMotionStageToContainer(std::shared_ptr<solvers::CartesianPath> &cartesian_planner, std::unique_ptr<SerialContainer> &container){
...
void PickPlaceTask::addMoveToHomeStageToTask(std::shared_ptr<solvers::PipelinePlanner> &sampling_planner, Task &t){
